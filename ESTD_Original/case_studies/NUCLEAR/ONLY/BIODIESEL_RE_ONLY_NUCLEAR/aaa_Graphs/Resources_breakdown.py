...
config = {
    ...
    "root_prefix": "BIODIESEL_RE_ONLY_NUCLEAR",  # Préfixe du dossier racine
    "save_path": Path("C:/Users/julem/Dropbox/EPL/TFE/TFE_textes/Images/TIPPING_POINT/NUCLEAR/BIODIESEL_ONLY_NUCLEAR"),  # Chemin de sauvegarde des graphiques
    "cost_enabled": True,
    "use_plotly": False,
