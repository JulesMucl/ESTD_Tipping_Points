...
root_prefix = "GAS_RE_ONLY_NUCLEAR"               # nom du dossier racine



scenario_name = "GAS_RE_ONLY_NUCLEAR_0.000"         # nom du scénario
...
sources_initiales = ["Imp. Gas", "Imp. Gas RE", "Imp. Ammonia RE"]  # "Wet biomass", , "Waste" , "Wood"
