...
config = {
    ...
    "root_prefix": "ammoniaRE_VS_gasRE",  # Préfixe du dossier racine

    "save_path": Path("C:/Users/julem/Dropbox/EPL/TFE/TFE_textes/Images/TIPPING_POINT/NUCLEAR/RATIO/ammoniaRE_VS_gasRE/"),  # Chemin de sauvegarde des graphiques
    "cost_enabled": True,
    "use_plotly": False,
