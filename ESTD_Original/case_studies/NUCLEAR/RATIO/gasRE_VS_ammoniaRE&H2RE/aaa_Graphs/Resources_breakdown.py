...
config = {
    ...
    "root_prefix": "gasRE_VS_ammoniaRE&H2RE",  # Préfixe du dossier racine

    "save_path": Path("C:/Users/julem/Dropbox/EPL/TFE/TFE_textes/Images/TIPPING_POINT/NUCLEAR/RATIO/gasRE_VS_ammoniaRE&H2RE/"),  # Chemin de sauvegarde des graphiques
    "cost_enabled": True,
    "use_plotly": False,
