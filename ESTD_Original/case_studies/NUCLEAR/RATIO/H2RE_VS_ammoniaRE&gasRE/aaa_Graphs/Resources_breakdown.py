...
config = {
    ...
    "root_prefix": "H2RE_VS_ammoniaRE&gasRE",  # Préfixe du dossier racine

    "save_path": Path("C:/Users/julem/Dropbox/EPL/TFE/TFE_textes/Images/TIPPING_POINT/NUCLEAR/RATIO/H2RE_VS_ammoniaRE&gasRE/"),  # Chemin de sauvegarde des graphiques
    "cost_enabled": True,
    "use_plotly": False,
