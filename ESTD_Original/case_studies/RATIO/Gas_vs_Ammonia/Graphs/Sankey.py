...
root_prefix = "Gas_vs_Ammonia"               # nom du dossier racine
...
if ZOOM:
    ...
    base_path = Path(f"C:/Users/julem/EnergyScope_Original/ESTD_Original/case_studies/RATIO/{root_prefix}/ZOOM/{scenario_name}/output/sankey")  # ZOOM



else:

    scenario_name = "GAS_0.025_AMMONIA_0.000"         # nom du scénario

    base_path = Path(f"C:/Users/julem/EnergyScope_Original/ESTD_Original/case_studies/RATIO/{root_prefix}/{scenario_name}/output/sankey")  # NORMAL
