...
config = {
    ...
    "root_prefix": "AMMONIA_RE_only",  # Préfixe du dossier racine (GAS_RE_only ou H2_RE_only)
    "save_path": Path("C:/Users/julem/Dropbox/EPL/TFE/TFE_textes/Images/TIPPING_POINT/"),
    "cost_enabled": True,
    "use_plotly": False,

    # Préfixes et plages de scénarios
    "scenario_prefix_zoom": "AMMONIA_RE_gwp_",
    "scenario_prefix_normal": "AMMONIA_RE_gwp_",
    "ZOOM" : False,
    "scenario_range_zoom": range(20, 36, 2),  
    "scenario_range_normal": range(0, 50, 5),
