...
config = {
    ...
    "root_prefix": "Methanol_RE_only",  # Préfixe du dossier racine (GAS_RE_only ou H2_RE_only)
    ...
    "scenario_prefix_normal": "NED_methanol_RE_",
    "ZOOM" : False,
    "scenario_range_zoom": range(20, 36, 2),  
    "scenario_range_normal": range(0, 60, 2),
