...
root_prefix = "METHANOL_RE_only"               # nom du dossier racine
...
if ZOOM:
    ...
    scenario_name = "NED_methanol_RE_0.240"         # nom du scénario
...
def drawSankey(path, outputfile='TO_REPLACE', auto_open=True):
    ...
    sources_initiales = ["Imp. Gas", "Imp. Gas RE", "Imp. Ammonia RE", "Wood","Imp. H2 RE","Imp. Methanol RE"]
