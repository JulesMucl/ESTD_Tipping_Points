...
config = {
    ...
    "selection_technos": ["CCGT_AMMONIA", "IND_COGEN_GAS","AMMONIA_TO_H2"],  # Technologies à sélectionner pour les graphiques

    "selection_resources": ["AMMONIA_RE", "H2_RE", "GAS_RE","GAS","METHANOL_RE"],  # Ressources à sélectionner pour les graphiques

    # Paramètres de base pour les chemins et préférences

    "root_prefix": "H2_RE_only",  # Préfixe du dossier racine (GAS_RE_only ou H2_RE_only)
    "save_path": Path("C:/Users/julem/Dropbox/EPL/TFE/TFE_textes/Images/TIPPING_POINT/"),
    "cost_enabled": True,
    "use_plotly": False,

    # Préfixes et plages de scénarios
    "scenario_prefix_zoom": "",
    "scenario_prefix_normal": "H2_RE_gwp_",
    "ZOOM" : False,
    "scenario_range_zoom": 0,  
    "scenario_range_normal": range(0, 54, 2),
